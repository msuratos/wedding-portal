...
namespace wedding_admin_cms.Persistance.Migrations
{
    ...
    [Migration("20220707170607_AddTrivia")]
    partial class AddTrivia
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wedding_admin_cms.Persistance.Entities.Trivia", b =>
                {
            ...
            modelBuilder.Entity("wedding_admin_cms.Persistance.Entities.TriviaQuestion", b =>
                {
            ...
            modelBuilder.Entity("wedding_admin_cms.Persistance.Entities.TriviaUserAnswer", b =>
                {
                    b.Property<Guid>("TriviaUserAnswerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWID()");
                    ...
                    b.HasKey("TriviaUserAnswerId");

                    b.HasIndex("TriviaQuestionId");

                    b.ToTable("TriviaUserAnswers");
                });
            ...
            modelBuilder.Entity("wedding_admin_cms.Persistance.Entities.TriviaQuestion", b =>
                {
                    b.HasOne("wedding_admin_cms.Persistance.Entities.Trivia", "Trivia")
            ...
            modelBuilder.Entity("wedding_admin_cms.Persistance.Entities.TriviaUserAnswer", b =>
                {
                    b.HasOne("wedding_admin_cms.Persistance.Entities.TriviaQuestion", "TriviaQuestion")
                        .WithMany("TriviaUserAnswers")
            ...
            modelBuilder.Entity("wedding_admin_cms.Persistance.Entities.TriviaQuestion", b =>
                {
                    b.Navigation("TriviaUserAnswers");
                });
