  ...
  return (
    <ListPageLayout>
      ...
      <Grid item xs={12} sx={{ pt: '10px' }}>
        <Typography variant='subtitle1' sx={{ textAlign: 'center' }} gutterBottom>Event #: 070822</Typography>
        <Button variant='contained' onClick={() => window.open('http://onlinequestions.org/')} fullWidth>Shoe Game (Press Me)</Button>
      </Grid>
      {/*<Grid item xs={12} sx={{ pt: '10px' }}>*/}
      {/*  {*/}
